...
import { User, Registration, Venue, Event, Group, Phone, Address } from '../models'
    ...
    Query: {
        ...
        events: async()=>{
            return await Event.find()
                ...
                .populate({path: 'venues', model: Venue, populate: [
        ...
        groups: async()=>{
            return await Group.find().populate([
                {path: 'registrations', model: Registration, populate: [
