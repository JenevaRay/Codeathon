...
const groupIds = [new mongoose_1.default.Types.ObjectId()];
const registrationIds = [
    new mongoose_1.default.Types.ObjectId(),
    new mongoose_1.default.Types.ObjectId(),
];
const userIds = [new mongoose_1.default.Types.ObjectId(), new mongoose_1.default.Types.ObjectId()];
const venueIds = [new mongoose_1.default.Types.ObjectId()];
const users = [
    {
