...
const DisplayBankTransferInstructions = ({
      ...
      <dl>
        ...
        {displayBankTransferInstructions.financial_addresses[0] ? (
          <>
            ...
            <dd>
              {
                displayBankTransferInstructions.financial_addresses[0].zengin
                  .bank_name
              }{' '}
              (
              {
        ...
        <dd>
          <pre>
            <code>
              {JSON.stringify(displayBankTransferInstructions, null, 2)}
            </code>
          </pre>
        </dd>
      </dl>
...
export const JPBankTransfer = () => {
  ...
  const [displayBankTransferInstructions, setDisplayBankTransferInstructions] =
    useState(null);
  return (
    <div>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            [支払い方法]の[追加]ボタンから、[現金残高に資金を追加(テスト環境のみ)]を選択
          </li>
          <li>金額を指定し、追加する</li>
        </ul>
        <p>
      ...
      <form
        ...
        onSubmit={async (e) => {
          ...
          addMessage(
            `Bank account information; ${JSON.stringify(
          ...
          setDisplayBankTransferInstructions(
            paymentIntent.nextAction.display_bank_transfer_instructions,
          );
        }}>
        <label>
