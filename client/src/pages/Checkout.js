          ...
          <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
              ...
              <div className="flex w-full flex-col px-4 py-4">
                ...
                <span className="float-right text-gray-400">9AM - 9PM</span>
            ...
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
              ...
              <div className="flex w-full flex-col px-4 py-4">
                ...
                <span className="float-right text-gray-400">Green</span>
        ...
        <div className="mt-10 bg-gray-50 px-4 pt-20 lg:mt-0">
          ...
          <div className="">
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <p className="text-2xl font-semibold text-gray-900">$75.00</p>
            </div>
          </div>
